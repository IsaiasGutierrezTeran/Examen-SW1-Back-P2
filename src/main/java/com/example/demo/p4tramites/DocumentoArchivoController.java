...
public class DocumentoArchivoController {
    ...
    @Autowired private com.example.demo.p4tramites.BlankOfficeTemplates blankTemplates;
    ...
    public ResponseEntity<DocumentoArchivoResponse> crearEnBlanco(
            @PathVariable String tramiteId,
            @RequestBody com.example.demo.p4tramites.CrearDocumentoBlancoRequest req,
            Authentication auth,
            HttpServletRequest request) {
