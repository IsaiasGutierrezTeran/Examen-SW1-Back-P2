...
public class DocumentoArchivoService {
    ...
    @Autowired private com.example.demo.p3politicas.NodoDiagramaRepository nodoRepository;
    ...
    public DocumentoArchivoResponse subirPorTramite(String tramiteId,
        ...
        if ((actividadId == null || actividadId.isBlank())
            ...
            actividadId = nodoRepository.findById(nodoId)
                    .map(com.example.demo.p3politicas.NodoDiagrama::getActividadId)
                    .orElse(null);
        }
        if (actividadId == null || actividadId.isBlank()) {
    ...
    public List<DocumentoArchivo> filtrarVisibles(List<DocumentoArchivo> docs, String rol) {
        ...
        Map<String, com.example.demo.p2organizacion.PermisoPuntoAtencion> cache = new java.util.HashMap<>();
    ...
    private boolean esLegibleParaFuncionario(
            ...
            Map<String, com.example.demo.p2organizacion.PermisoPuntoAtencion> cache) {
