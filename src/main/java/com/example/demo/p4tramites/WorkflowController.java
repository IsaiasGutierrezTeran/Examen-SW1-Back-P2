...
import com.example.demo.p3politicas.FlujoCompletoResponse;
...
public class WorkflowController {
    ...
    public ResponseEntity<List<Map<String, Object>>> misPendientes(
        ...
        List<Tramite> pendientes = activos.stream()
                ...
                .filter(t -> esAdmin || asignadoAlFuncionario(t, userId))
    ...
    /**
     * Un funcionario tiene el trámite en su bandeja si:
     *  - flujo secuencial: es el funcionarioActualId, o
     *  - flujo en paralelo (fork): tiene al menos UNA sección de las ramas
     *    activas asignada a él y en estado trabajable. Esto corrige el bug de
    ...
    private boolean esEstadoTrabajable(EstadoSeccion e) {
        return e == EstadoSeccion.PENDIENTE_RECEPCION
                || e == EstadoSeccion.EN_EJECUCION
